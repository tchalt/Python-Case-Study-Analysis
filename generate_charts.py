...
working_dir = "/Users/tangtaowei/Desktop/MC PF/IE/Mar 17"
os.chdir(working_dir)

# Core Data from latest refined_financial_model.py (Wage 7.05 EUR/h)
years = [2026, 2027, 2028, 2029, 2030]
revenue = [137.7, 204.5, 243.0, 253.9, 262.0] # Million EUR
ebitda = [23.9, 36.6, 43.5, 44.6, 42.9] # Million EUR
total_costs = [r - e for r, e in zip(revenue, ebitda)] # 113.8, 167.9, 199.5, 209.3, 219.1
eff_capacity_mw = [1092.5, 1656.0, 2007.9, 2141.3, 2254.0]

# --- Mandatory Chart 1: Volume Ramp-up ---
...
for bar in bars:
    yval = bar.get_height()
    plt.text(bar.get_x() + bar.get_width()/2, yval + 20, f'{yval:,.0f}', ha='center', va='bottom', fontsize=10, fontweight='bold')

plt.title("Production Volume Ramp-up (2026-2030)", fontsize=14, fontweight='bold')
...
# --- Mandatory Chart 2: Break-even Analysis (2026-2030) ---
plt.figure(figsize=(10, 6))
...
plt.annotate(f'2030 EBITDA: €{ebitda[-1]:.1f}M', 
             xy=(2030, revenue[-1]), xytext=(2028, 255),
